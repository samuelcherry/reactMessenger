...
console.log("textbox log: ", username)
	...
	return(
		<>
			<form className="flex justify-between items-center pt-5" onSubmit={sendMessage}>
				<input
					type="text"
					value={inputValue}
					className="outline-solid h-1/10 w-8/10 lg:w-19/20"
					onChange={handleChange}
				/>
				<button className="rounded-full bg-sky-400 p-2 lg:p-4" type="submit">
